jQuery(document).ready(function ($) {
    ...
    $('.pyroly2').height($('.pyroly2 .Act').outerHeight());
    jQuery('.pg-fold .Sin,.pyroly2 .Sin').mousemove(function () {
...
jQuery(document).ready(function ($) {
    ...
    tabSin('.tbSn');
    $('.TDU3 .Sin,.TDU7 .Sin').mouseover(function () { 
        $(this).addClass('Act').siblings().removeClass('Act');
    });
});

jQuery(document).ready(function ($) {
    $('.plastPyroly8 .Sin').mouseover(function () { 
        $(this).addClass('Act').siblings().removeClass('Act');
    });
});
...
jQuery(document).ready(function ($) {
    function mvH1c(hd, h1c) { 
        if (hd && h1c) { 
            h1c.insertBefore(hd, h1c.firstChild); 
        } 
    }
...
jQuery(document).ready(function ($) {
    $('.btHom1 .Sin,.btHom2 .Sin').mouseover(function () { 
        $(this).addClass('Act').siblings().removeClass('Act');
    });
...
jQuery(document).ready(function($) {
    jQuery('.btHom1 .Sin,.btHom2 .Sin').mouseover(function() {
        jQuery(this).addClass('Act').siblings().removeClass('Act');
    });
    jQuery('.btHom4').each(function() {
        var $tabs = jQuery(this).find('.Tab');
        var $sins = jQuery(this).find('.Sin');
        var timer;
        var ind = 0;
        function tag(i) {
            $tabs.eq(i).addClass('Act').siblings().removeClass('Act');
    ...
    jQuery('.btHom5 .Sin').each(function() {
        var $tabs = jQuery(this).find('.Tab');
        var $Pics = jQuery(this).find('.Pic');
        $tabs.on('mouseenter', function() {
            $Pics.eq(jQuery(this).index()).addClass('Act').siblings().removeClass('Act');
        });
        $tabs.on('mouseleave', function() {
            $Pics.removeClass('Act');
        });
